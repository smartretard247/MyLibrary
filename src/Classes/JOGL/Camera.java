 ...
 * calling methods.
 *     The camera comes along with a simulated track ball that
...
public class Camera {
  ...
  * @param gl
  ...
  /**
   * Installs a simulated track ball for an OpenGL component, which must be the
   ...
   * @param c  The OpenGL drawing surface where the track ball will be installed.
   *    This is probably a GLJPanel or GLCanvas.  Passing a null as the parameter
   *    will remove the track ball from the component (if it has been installed
   *    there).
   */
